Source-Makefile: feeds/telephony/net/kamailio-4.0.x/Makefile
Package: kamailio4
Menu: 1
Submenu: Telephony
Version: 4.0.4-1
...
Source: kamailio-4.0.4_src.tar.gz
Type: ipkg
Description: Mature and flexible open source SIP server, v4.0.x
