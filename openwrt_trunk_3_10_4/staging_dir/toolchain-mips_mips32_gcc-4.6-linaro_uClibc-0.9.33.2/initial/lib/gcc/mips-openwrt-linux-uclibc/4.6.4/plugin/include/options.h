...
enum opt_code
{
  ...
  OPT_Werror_maybe_reset = 212,              /* -Werror-maybe-reset */
  ...
  OPT_Wstatic_access = 319,                  /* -Wstatic-access */
  OPT_Wstatic_receiver = 320,                /* -Wstatic-receiver */
  OPT_Wstrict_aliasing = 321,                /* -Wstrict-aliasing */
  OPT_Wstrict_aliasing_ = 322,               /* -Wstrict-aliasing= */
  OPT_Wstrict_null_sentinel = 323,           /* -Wstrict-null-sentinel */
  OPT_Wstrict_overflow = 324,                /* -Wstrict-overflow */
  OPT_Wstrict_overflow_ = 325,               /* -Wstrict-overflow= */
  OPT_Wstrict_prototypes = 326,              /* -Wstrict-prototypes */
  OPT_Wstrict_selector_match = 327,          /* -Wstrict-selector-match */
  OPT_Wsuggest_attribute_const = 328,        /* -Wsuggest-attribute=const */
  OPT_Wsuggest_attribute_noreturn = 329,     /* -Wsuggest-attribute=noreturn */
  OPT_Wsuggest_attribute_pure = 330,         /* -Wsuggest-attribute=pure */
  OPT_Wsuppress = 331,                       /* -Wsuppress */
  OPT_Wsurprising = 332,                     /* -Wsurprising */
  OPT_Wswitch = 333,                         /* -Wswitch */
  OPT_Wswitch_default = 334,                 /* -Wswitch-default */
  OPT_Wswitch_enum = 335,                    /* -Wswitch-enum */
  OPT_Wsync_nand = 336,                      /* -Wsync-nand */
  OPT_Wsynth = 337,                          /* -Wsynth */
  OPT_Wsynthetic_access = 338,               /* -Wsynthetic-access */
  OPT_Wsystem_headers = 339,                 /* -Wsystem-headers */
  OPT_Wtabs = 340,                           /* -Wtabs */
  OPT_Wtasks = 341,                          /* -Wtasks */
  OPT_Wtraditional = 342,                    /* -Wtraditional */
  OPT_Wtraditional_conversion = 343,         /* -Wtraditional-conversion */
  OPT_Wtrampolines = 344,                    /* -Wtrampolines */
  OPT_Wtrigraphs = 345,                      /* -Wtrigraphs */
  OPT_Wtype_hiding = 346,                    /* -Wtype-hiding */
  OPT_Wtype_limits = 347,                    /* -Wtype-limits */
  OPT_Wuncheck = 348,                        /* -Wuncheck */
  OPT_Wundeclared_selector = 349,            /* -Wundeclared-selector */
  OPT_Wundef = 350,                          /* -Wundef */
  OPT_Wunderflow = 351,                      /* -Wunderflow */
  OPT_Wuninitialized = 352,                  /* -Wuninitialized */
  OPT_Wunknown_pragmas = 353,                /* -Wunknown-pragmas */
  OPT_Wunnecessary_else = 354,               /* -Wunnecessary-else */
  OPT_Wunqualified_field = 355,              /* -Wunqualified-field */
  /* OPT_Wunreachable_code = 356, */         /* -Wunreachable-code */
  OPT_Wunsafe_loop_optimizations = 357,      /* -Wunsafe-loop-optimizations */
  OPT_Wunsuffixed_float_constants = 358,     /* -Wunsuffixed-float-constants */
  OPT_Wunused = 359,                         /* -Wunused */
  OPT_Wunused_argument = 360,                /* -Wunused-argument */
  OPT_Wunused_but_set_parameter = 361,       /* -Wunused-but-set-parameter */
  OPT_Wunused_but_set_variable = 362,        /* -Wunused-but-set-variable */
  OPT_Wunused_dummy_argument = 363,          /* -Wunused-dummy-argument */
  OPT_Wunused_function = 364,                /* -Wunused-function */
  OPT_Wunused_import = 365,                  /* -Wunused-import */
  OPT_Wunused_label = 366,                   /* -Wunused-label */
  OPT_Wunused_local = 367,                   /* -Wunused-local */
  OPT_Wunused_macros = 368,                  /* -Wunused-macros */
  OPT_Wunused_parameter = 369,               /* -Wunused-parameter */
  OPT_Wunused_private = 370,                 /* -Wunused-private */
  OPT_Wunused_result = 371,                  /* -Wunused-result */
  OPT_Wunused_thrown = 372,                  /* -Wunused-thrown */
  OPT_Wunused_value = 373,                   /* -Wunused-value */
  OPT_Wunused_variable = 374,                /* -Wunused-variable */
  OPT_Wuseless_type_check = 375,             /* -Wuseless-type-check */
  OPT_Wvarargs_cast = 376,                   /* -Wvarargs-cast */
  OPT_Wvariadic_macros = 377,                /* -Wvariadic-macros */
  OPT_Wvla = 378,                            /* -Wvla */
  OPT_Wvolatile_register_var = 379,          /* -Wvolatile-register-var */
  OPT_Wwarning_token = 380,                  /* -Wwarning-token */
  OPT_Wwrite_strings = 381,                  /* -Wwrite-strings */
  OPT_Xassembler = 382,                      /* -Xassembler */
  OPT_Xlinker = 383,                         /* -Xlinker */
  OPT_Xpreprocessor = 384,                   /* -Xpreprocessor */
  OPT_Z = 385,                               /* -Z */
  OPT_ansi = 386,                            /* -ansi */
  OPT_aux_info = 387,                        /* -aux-info */
  /* OPT_aux_info_ = 388, */                 /* -aux-info= */
  OPT_auxbase = 389,                         /* -auxbase */
  OPT_auxbase_strip = 390,                   /* -auxbase-strip */
  /* OPT_bootclasspath = 391, */             /* -bootclasspath */
  OPT_c = 392,                               /* -c */
  /* OPT_classpath = 393, */                 /* -classpath */
  OPT_coverage = 394,                        /* -coverage */
  OPT_cpp = 395,                             /* -cpp */
  OPT_cpp_ = 396,                            /* -cpp= */
  OPT_d = 397,                               /* -d */
  OPT_dumpbase = 398,                        /* -dumpbase */
  OPT_dumpdir = 399,                         /* -dumpdir */
  OPT_dumpmachine = 400,                     /* -dumpmachine */
  OPT_dumpspecs = 401,                       /* -dumpspecs */
  OPT_dumpversion = 402,                     /* -dumpversion */
  OPT_e = 403,                               /* -e */
  /* OPT_encoding = 404, */                  /* -encoding */
  OPT_export_dynamic = 405,                  /* -export-dynamic */
  OPT_extdirs = 406,                         /* -extdirs */
  /* OPT_fCLASSPATH_ = 407, */               /* -fCLASSPATH= */
  OPT_fPIC = 408,                            /* -fPIC */
  OPT_fPIE = 409,                            /* -fPIE */
  OPT_fRTS_ = 410,                           /* -fRTS= */
  OPT_fabi_version_ = 411,                   /* -fabi-version= */
  OPT_faccess_control = 412,                 /* -faccess-control */
  ...
  OPT_fhonour_copts = 587,                   /* -fhonour-copts */
  ...
  OPT_floop_strip_mine = 646,                /* -floop-strip-mine */
  OPT_flto = 647,                            /* -flto */
  OPT_flto_compression_level_ = 648,         /* -flto-compression-level= */
  OPT_flto_partition_1to1 = 649,             /* -flto-partition=1to1 */
  OPT_flto_partition_balanced = 650,         /* -flto-partition=balanced */
  OPT_flto_partition_none = 651,             /* -flto-partition=none */
  OPT_flto_report = 652,                     /* -flto-report */
  OPT_flto_ = 653,                           /* -flto= */
  OPT_fltrans = 654,                         /* -fltrans */
  OPT_fltrans_output_list_ = 655,            /* -fltrans-output-list= */
  OPT_fmain_ = 656,                          /* -fmain= */
  OPT_fmath_errno = 657,                     /* -fmath-errno */
  OPT_fmax_array_constructor_ = 658,         /* -fmax-array-constructor= */
  OPT_fmax_errors_ = 659,                    /* -fmax-errors= */
  OPT_fmax_identifier_length_ = 660,         /* -fmax-identifier-length= */
  OPT_fmax_stack_var_size_ = 661,            /* -fmax-stack-var-size= */
  OPT_fmax_subrecord_length_ = 662,          /* -fmax-subrecord-length= */
  OPT_fmem_report = 663,                     /* -fmem-report */
  OPT_fmerge_all_constants = 664,            /* -fmerge-all-constants */
  OPT_fmerge_constants = 665,                /* -fmerge-constants */
  OPT_fmerge_debug_strings = 666,            /* -fmerge-debug-strings */
  OPT_fmessage_length_ = 667,                /* -fmessage-length= */
  OPT_fmodule_private = 668,                 /* -fmodule-private */
  OPT_fmodulo_sched = 669,                   /* -fmodulo-sched */
  OPT_fmodulo_sched_allow_regmoves = 670,    /* -fmodulo-sched-allow-regmoves */
  OPT_fmove_loop_invariants = 671,           /* -fmove-loop-invariants */
  OPT_fms_extensions = 672,                  /* -fms-extensions */
  OPT_fmudflap = 673,                        /* -fmudflap */
  OPT_fmudflapir = 674,                      /* -fmudflapir */
  OPT_fmudflapth = 675,                      /* -fmudflapth */
  /* OPT_fname_mangling_version_ = 676, */   /* -fname-mangling-version- */
  /* OPT_fnew_abi = 677, */                  /* -fnew-abi */
  OPT_fnext_runtime = 678,                   /* -fnext-runtime */
  OPT_fnil_receivers = 679,                  /* -fnil-receivers */
  OPT_fnon_call_exceptions = 680,            /* -fnon-call-exceptions */
  OPT_fnonansi_builtins = 681,               /* -fnonansi-builtins */
  /* OPT_fnonnull_objects = 682, */          /* -fnonnull-objects */
  OPT_fnothrow_opt = 683,                    /* -fnothrow-opt */
  OPT_fobjc_abi_version_ = 684,              /* -fobjc-abi-version= */
  OPT_fobjc_call_cxx_cdtors = 685,           /* -fobjc-call-cxx-cdtors */
  OPT_fobjc_direct_dispatch = 686,           /* -fobjc-direct-dispatch */
  OPT_fobjc_exceptions = 687,                /* -fobjc-exceptions */
  OPT_fobjc_gc = 688,                        /* -fobjc-gc */
  OPT_fobjc_nilcheck = 689,                  /* -fobjc-nilcheck */
  OPT_fobjc_sjlj_exceptions = 690,           /* -fobjc-sjlj-exceptions */
  OPT_fobjc_std_objc1 = 691,                 /* -fobjc-std=objc1 */
  OPT_fomit_frame_pointer = 692,             /* -fomit-frame-pointer */
  OPT_fopenmp = 693,                         /* -fopenmp */
  OPT_foperator_names = 694,                 /* -foperator-names */
  OPT_foptimize_register_move = 695,         /* -foptimize-register-move */
  OPT_foptimize_sibling_calls = 696,         /* -foptimize-sibling-calls */
  OPT_foptimize_static_class_initialization = 697,/* -foptimize-static-class-initialization */
  /* OPT_foptional_diags = 698, */           /* -foptional-diags */
  OPT_foutput_class_dir_ = 699,              /* -foutput-class-dir= */
  OPT_fpack_derived = 700,                   /* -fpack-derived */
  OPT_fpack_struct = 701,                    /* -fpack-struct */
  OPT_fpack_struct_ = 702,                   /* -fpack-struct= */
  OPT_fpartial_inlining = 703,               /* -fpartial-inlining */
  OPT_fpcc_struct_return = 704,              /* -fpcc-struct-return */
  OPT_fpch_deps = 705,                       /* -fpch-deps */
  OPT_fpch_preprocess = 706,                 /* -fpch-preprocess */
  OPT_fpeel_loops = 707,                     /* -fpeel-loops */
  OPT_fpeephole = 708,                       /* -fpeephole */
  OPT_fpeephole2 = 709,                      /* -fpeephole2 */
  OPT_fpermissive = 710,                     /* -fpermissive */
  OPT_fpic = 711,                            /* -fpic */
  OPT_fpie = 712,                            /* -fpie */
  OPT_fplan9_extensions = 713,               /* -fplan9-extensions */
  OPT_fplugin_arg_ = 714,                    /* -fplugin-arg- */
  OPT_fplugin_ = 715,                        /* -fplugin= */
  OPT_fpost_ipa_mem_report = 716,            /* -fpost-ipa-mem-report */
  OPT_fpre_ipa_mem_report = 717,             /* -fpre-ipa-mem-report */
  OPT_fpredictive_commoning = 718,           /* -fpredictive-commoning */
  OPT_fprefetch_loop_arrays = 719,           /* -fprefetch-loop-arrays */
  OPT_fpreprocessed = 720,                   /* -fpreprocessed */
  OPT_fpretty_templates = 721,               /* -fpretty-templates */
  OPT_fprofile = 722,                        /* -fprofile */
  OPT_fprofile_arcs = 723,                   /* -fprofile-arcs */
  OPT_fprofile_correction = 724,             /* -fprofile-correction */
  OPT_fprofile_dir_ = 725,                   /* -fprofile-dir= */
  OPT_fprofile_generate = 726,               /* -fprofile-generate */
  OPT_fprofile_generate_ = 727,              /* -fprofile-generate= */
  OPT_fprofile_use = 728,                    /* -fprofile-use */
  OPT_fprofile_use_ = 729,                   /* -fprofile-use= */
  OPT_fprofile_values = 730,                 /* -fprofile-values */
  OPT_fprotect_parens = 731,                 /* -fprotect-parens */
  OPT_frandom_seed = 732,                    /* -frandom-seed */
  OPT_frandom_seed_ = 733,                   /* -frandom-seed= */
  OPT_frange_check = 734,                    /* -frange-check */
  OPT_frealloc_lhs = 735,                    /* -frealloc-lhs */
  OPT_freciprocal_math = 736,                /* -freciprocal-math */
  OPT_frecord_gcc_switches = 737,            /* -frecord-gcc-switches */
  OPT_frecord_marker_4 = 738,                /* -frecord-marker=4 */
  OPT_frecord_marker_8 = 739,                /* -frecord-marker=8 */
  OPT_frecursive = 740,                      /* -frecursive */
  ...
  OPT_imultiarch = 936,                      /* -imultiarch */
  OPT_imultilib = 937,                       /* -imultilib */
  OPT_include = 938,                         /* -include */
  OPT_iplugindir_ = 939,                     /* -iplugindir= */
  OPT_iprefix = 940,                         /* -iprefix */
  OPT_iquote = 941,                          /* -iquote */
  OPT_isysroot = 942,                        /* -isysroot */
  OPT_isystem = 943,                         /* -isystem */
  OPT_iwithprefix = 944,                     /* -iwithprefix */
  OPT_iwithprefixbefore = 945,               /* -iwithprefixbefore */
  OPT_k8 = 946,                              /* -k8 */
  OPT_l = 947,                               /* -l */
  OPT_lang_asm = 948,                        /* -lang-asm */
  OPT_mabi_ = 949,                           /* -mabi= */
  OPT_mabicalls = 950,                       /* -mabicalls */
  OPT_mad = 951,                             /* -mad */
  OPT_mandroid = 952,                        /* -mandroid */
  OPT_march_ = 953,                          /* -march= */
  OPT_mbionic = 954,                         /* -mbionic */
  OPT_mbranch_cost_ = 955,                   /* -mbranch-cost= */
  OPT_mbranch_likely = 956,                  /* -mbranch-likely */
  OPT_mcheck_zero_division = 957,            /* -mcheck-zero-division */
  OPT_mcode_readable_ = 958,                 /* -mcode-readable= */
  OPT_mdebug = 959,                          /* -mdebug */
  OPT_mdebugd = 960,                         /* -mdebugd */
  OPT_mdivide_breaks = 961,                  /* -mdivide-breaks */
  OPT_mdivide_traps = 962,                   /* -mdivide-traps */
  OPT_mdmx = 963,                            /* -mdmx */
  OPT_mdouble_float = 964,                   /* -mdouble-float */
  OPT_mdsp = 965,                            /* -mdsp */
  OPT_mdspr2 = 966,                          /* -mdspr2 */
  OPT_meb = 967,                             /* -meb */
  OPT_mel = 968,                             /* -mel */
  OPT_membedded_data = 969,                  /* -membedded-data */
  OPT_mexplicit_relocs = 970,                /* -mexplicit-relocs */
  OPT_mextern_sdata = 971,                   /* -mextern-sdata */
  OPT_mfix_r10000 = 972,                     /* -mfix-r10000 */
  OPT_mfix_r4000 = 973,                      /* -mfix-r4000 */
  OPT_mfix_r4400 = 974,                      /* -mfix-r4400 */
  OPT_mfix_sb1 = 975,                        /* -mfix-sb1 */
  OPT_mfix_vr4120 = 976,                     /* -mfix-vr4120 */
  OPT_mfix_vr4130 = 977,                     /* -mfix-vr4130 */
  OPT_mfix4300 = 978,                        /* -mfix4300 */
  OPT_mflip_mips16 = 979,                    /* -mflip-mips16 */
  OPT_mflush_func_ = 980,                    /* -mflush-func= */
  OPT_mfp_exceptions = 981,                  /* -mfp-exceptions */
  OPT_mfp32 = 982,                           /* -mfp32 */
  OPT_mfp64 = 983,                           /* -mfp64 */
  ...
  OPT_mgp32 = 986,                           /* -mgp32 */
  OPT_mgp64 = 987,                           /* -mgp64 */
  OPT_mgpopt = 988,                          /* -mgpopt */
  OPT_mhard_float = 989,                     /* -mhard-float */
  OPT_minterlink_mips16 = 990,               /* -minterlink-mips16 */
  OPT_mips = 991,                            /* -mips */
  OPT_mips16 = 992,                          /* -mips16 */
  OPT_mips3d = 993,                          /* -mips3d */
  OPT_mllsc = 994,                           /* -mllsc */
  OPT_mlocal_sdata = 995,                    /* -mlocal-sdata */
  OPT_mlong_calls = 996,                     /* -mlong-calls */
  OPT_mlong32 = 997,                         /* -mlong32 */
  OPT_mlong64 = 998,                         /* -mlong64 */
  OPT_mmcount_ra_address = 999,              /* -mmcount-ra-address */
  OPT_mmemcpy = 1000,                        /* -mmemcpy */
  OPT_mmips_tfile = 1001,                    /* -mmips-tfile */
  OPT_mmt = 1002,                            /* -mmt */
  OPT_mmusl = 1003,                          /* -mmusl */
  OPT_mno_float = 1004,                      /* -mno-float */
  OPT_mno_flush_func = 1005,                 /* -mno-flush-func */
  OPT_mno_mdmx = 1006,                       /* -mno-mdmx */
  OPT_mno_mips16 = 1007,                     /* -mno-mips16 */
  OPT_mno_mips3d = 1008,                     /* -mno-mips3d */
  OPT_mpaired_single = 1009,                 /* -mpaired-single */
  OPT_mplt = 1010,                           /* -mplt */
  OPT_mr10k_cache_barrier_ = 1011,           /* -mr10k-cache-barrier= */
  OPT_mrelax_pic_calls = 1012,               /* -mrelax-pic-calls */
  OPT_mshared = 1013,                        /* -mshared */
  OPT_msingle_float = 1014,                  /* -msingle-float */
  OPT_msmartmips = 1015,                     /* -msmartmips */
  OPT_msoft_float = 1016,                    /* -msoft-float */
  OPT_msplit_addresses = 1017,               /* -msplit-addresses */
  OPT_msym32 = 1018,                         /* -msym32 */
  OPT_msynci = 1019,                         /* -msynci */
  OPT_mtune_ = 1020,                         /* -mtune= */
  OPT_muclibc = 1021,                        /* -muclibc */
  OPT_muninit_const_in_rodata = 1022,        /* -muninit-const-in-rodata */
  OPT_mvr4130_align = 1023,                  /* -mvr4130-align */
  OPT_mxgot = 1024,                          /* -mxgot */
  OPT_n = 1025,                              /* -n */
  OPT_no_canonical_prefixes = 1026,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1027,              /* -no-integrated-cpp */
  OPT_noasmopt = 1028,                       /* -noasmopt */
  ...
  OPT_pie = 1041,                            /* -pie */
  OPT_pipe = 1042,                           /* -pipe */
  OPT_posix = 1043,                          /* -posix */
  OPT_print_file_name_ = 1044,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1045,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1046,          /* -print-multi-directory */
  OPT_print_multi_lib = 1047,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1048,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1049,                /* -print-multiarch */
  ...
  OPT_profile = 1055,                        /* -profile */
  OPT_pthread = 1056,                        /* -pthread */
  OPT_quiet = 1057,                          /* -quiet */
  OPT_r = 1058,                              /* -r */
  OPT_rdynamic = 1059,                       /* -rdynamic */
  ...
  OPT_std_gnu__0x = 1087,                    /* -std=gnu++0x */
  ...
  OPT_time = 1101,                           /* -time */
  OPT_time_ = 1102,                          /* -time= */
  OPT_tno_android_cc = 1103,                 /* -tno-android-cc */
  OPT_tno_android_ld = 1104,                 /* -tno-android-ld */
